...
const Carousel = () => {
  ...
  const groups = chunkArray(images, 6);
  ...
  return (
    <div className="container relative h-[56px] w-full">
      {groups.map((group: any, index: number) => (
        ...
        >
          <div className="flex h-full w-full items-center justify-between justify-between gap-8 overflow-hidden opacity-[0.75] lg:gap-0">
