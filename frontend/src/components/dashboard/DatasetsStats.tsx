    ...
    <div className="my-10">
      ...
      <dl className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {stats.map((item) => (
          <div
            key={item.id}
            className="relative overflow-hidden rounded-lg bg-white dark:bg-slate-900 px-4 pb-12 pt-5 shadow sm:px-6 sm:pt-6"
          >
            <dt>
              <div className="absolute rounded-md bg-slate-100 dark:bg-slate-800 p-3">
            ...
            <dd className="ml-16 flex items-baseline pb-6 sm:pb-7">
              ...
              {item.cta && (
                <div className="absolute inset-x-0 bottom-0 bg-slate-100 dark:bg-slate-900 px-4 py-4 sm:px-6">
