...
import { Resource, ResourceInfo } from "@portaljs/ckan";
...
export const getServerSideProps: GetStaticProps = async (context) => {
  ...
  try {
    ...
    const resourceMetadata = await ckan.getResourceMetadata(
    ...
    return {
      props: { resource: { ...resourceMetadata } },
    };
  } catch (e) {
    return {
      notFound: true,
...
export default function ResourcePage({
  ...
  return (
    <>
      <Layout>
        <div className="grid-rows-datasetpage-hero">
          ...
          <section className="row-start-2 row-span-2 col-span-full pb-16">
            <div className="custom-container bg-[#fcfcfc] lg:px-4 py-8 rounded">
              ...
              <div className="lg:px-8">
                ...
                {["png", "jpeg", "webp"].includes(resourceFormat ?? '') && (
