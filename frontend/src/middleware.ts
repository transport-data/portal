...
export const config = {
  matcher: [
    ...
    "/((?!api|_next/static|_next/image|favicon.ico|images|styles|dashboard|onboarding|auth|search|datasets|organizations|groups|geography|partners|about-us|contact|events|data-provider|faq|privacy-policy|terms-and-conditions|unauthorized|404|showroom|pdfs|licenses|knowledge-hub).*)",
  ],
};
